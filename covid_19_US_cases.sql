...
--Which States contained the most amount of total cases overall
...
--which states contained the most amount of new cases in one day
...
--which states contains the least amount of total cases overall
ALTER TABLE covid19_us_cases ALTER COLUMN total_cases TYPE float8;
select "State", sum(total_cases) as sum_of_total_cases
from covid19_us_cases
group by "State"
...
--which states contained the least amount of new cases in one day after 2021
ALTER TABLE covid19_us_cases ALTER COLUMN new_cases TYPE float8;
...
--what is the new cases to total cases percentage for each date in each state
ALTER TABLE covid19_us_cases ALTER COLUMN total_cases TYPE float8;
ALTER TABLE covid19_us_cases ALTER COLUMN new_cases TYPE float8;
...
--what is the overall new cases to total cases percentage for each state 
ALTER TABLE covid19_us_cases ALTER COLUMN total_cases TYPE float8;
ALTER TABLE covid19_us_cases ALTER COLUMN new_cases TYPE float8;
...
--what is the average total cases per state
